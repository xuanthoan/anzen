  ...
  return (
    <form action={onSubmit} onFocus={onStart} className="rounded-[2rem] bg-white p-6 shadow-2xl md:p-8" noValidate>
      <div className="grid gap-5 md:grid-cols-2">
        <div><label htmlFor="fullName" className="text-sm font-semibold text-slate-800">Họ tên *</label><input id="fullName" name="fullName" required maxLength={80} autoComplete="name" className="mt-2 min-h-12 w-full rounded-2xl border border-slate-300 bg-white px-4 text-slate-950 caret-emerald-700 placeholder:text-slate-400 focus:border-emerald-600 focus:ring-2 focus:ring-emerald-500/50" /></div>
        <div><label htmlFor="phone" className="text-sm font-semibold text-slate-800">Số điện thoại *</label><input id="phone" name="phone" required maxLength={20} autoComplete="tel" inputMode="tel" className="mt-2 min-h-12 w-full rounded-2xl border border-slate-300 bg-white px-4 text-slate-950 caret-emerald-700 placeholder:text-slate-400 focus:border-emerald-600 focus:ring-2 focus:ring-emerald-500/50" /></div>
        <div className="md:col-span-2"><label htmlFor="email" className="text-sm font-semibold text-slate-800">Email</label><input id="email" name="email" type="email" maxLength={120} autoComplete="email" className="mt-2 min-h-12 w-full rounded-2xl border border-slate-300 bg-white px-4 text-slate-950 caret-emerald-700 placeholder:text-slate-400 focus:border-emerald-600 focus:ring-2 focus:ring-emerald-500/50" /></div>
