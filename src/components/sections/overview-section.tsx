...
export function OverviewSection() {
  return (
    <section id="tong-quan" className="bg-slate-50 py-20 md:py-28">
      <Container>
        <SectionHeading eyebrow="Tổng quan" title="Tổng quan An Zen Residences" description="An Zen Residences tọa lạc trên đường Trang Quan, phường An Hải, TP. Hải Phòng, được quy hoạch trên quy mô 1,49 ha với 3 block căn hộ cao 18 tầng và 887 căn hộ EHome." />
