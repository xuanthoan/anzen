  ...
  return (
    <section className="bg-emerald-950 py-20 text-white md:py-28">
      <Container className="grid items-center gap-12 lg:grid-cols-2">
        ...
        <div className="relative aspect-[4/5] overflow-hidden rounded-[2rem] bg-emerald-900"><Image src="/images/project/brand.jpg" alt="Không gian sống xanh và tiện ích cộng đồng" fill sizes="(min-width: 1024px) 50vw, 100vw" className="object-cover" /></div>
      </Container>
    </section>
  );
}
